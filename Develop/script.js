...
var possibleChars = [];
var tempPasswod = [];
var pwdLenght = parseInt(window.prompt("Please enter password leght between 8 and 128"));
...
var upperConfirm = window.confirm("Do you want upper case letters in your password?")

var lowerConfirm = window.confirm("Do you want lower case letters in your password?")
...
for(var i=0; i<pwdLenght; i++){
  tempPasswod.push(possibleChars[Math.floor(Math.random() * possibleChars.length)]);
